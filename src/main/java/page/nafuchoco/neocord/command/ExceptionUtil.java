...
public class ExceptionUtil {
    ...
    public static void sendStackTrace(CommandContext context, Throwable throwable, String... message) {
        sendStackTrace(context, true, throwable, message);
    }

    public static void sendStackTrace(CommandContext context, boolean toLog, Throwable throwable, String... message) {
        ...
        context.getHook().sendMessage(builder.toString()).queue();
